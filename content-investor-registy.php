<div class="investor-register-box col-md-12">
	<h2 class="entry-title col-md-12">Preferred Investor Program<span>My Profile</span></h2>
	<div class="col-md-12">
		<div class="line top col-md-12"></div>
	</div>
	<div class="investor-form col-md-12">
		<form id="frm_invstor" name="frm_search" action="search_result.php">
			<div class="col-md-12">
				...
				<div class="form-item col-md-6 three">
				...
				foreach ($interests_states as $key => $value) :
					?>
					<div class="form-item check-group col-md-3">
				...
				<?php foreach ($interests_states as $key => $value) : ?>
					...
					<?php foreach ($value as $row) : ?>
						<div class="form-item check-group col-md-2">
				...
				<div class="form-item col-md-12 one">
				...
				<div class="form-item col-md-6 indicate">
					<p>Please indicate Your Purchase Price Range</p>
				</div>
				<div class="form-item col-md-3 indicate-from">
				...
				<div class="form-item col-md-12 two">
